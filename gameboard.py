class GameBoard:
    ...
    def create_faller(self, command_lst: list) -> None:
        ...
        Args:
            - command_lst (list): includes colors for parsing
...
class Vitamin:
    ...
    def move_right(self, grid: list) -> None:
        ...
        if self.direction == 'vertical':
            ...
            #if the new spots after moving right is already taken, do NOTHING and return 
            if (grid[self.top_row][new_column] != '   ') or (grid[self.top_row + 1][new_column] != '   '):
                return
            ...
            if new_right_column < grid_column:
                ...
                #if the new spots after moving right is already taken, do NOTHING and return 
                if (grid[self.row][new_right_column] != '   '):
                    return 
    ...
    def move_left(self, grid: list) -> None:
        ...
        if self.direction == 'vertical':
            ...
            #if the new spots after moving left is already taken, do NOTHING and return 
            if (grid[self.top_row][new_column] != '   ') or (grid[self.top_row + 1][new_column] != '   '):
                return
            ...
            #if the new spots after moving left is already taken, do NOTHING and return 
            if (grid[self.row][new_left_column] != '   '):
                return
    ...
    def set_direction(self, direction: str) -> None:
        ...
        Args:
            - direction (str): sets the direction of the vitamin capsule
